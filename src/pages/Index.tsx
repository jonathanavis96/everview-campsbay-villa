...
// dividers start at 360. Remaining content sections (power and water, the
// area, the plates) land in follow-up MIS-449 PRs, each claiming the next
// unused sub-range between BedroomsSection and the enquiry composer, left
// to right, continuing on from 960 below.
const Index = () => {
  return (
    <div className="min-h-screen bg-paper">
      ...
      <BedroomsSection />
      <RidgelineDivider from={960} to={1160} className="container py-2" />
      <EnquiryComposer />
