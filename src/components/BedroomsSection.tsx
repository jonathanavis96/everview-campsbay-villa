  ...
  return (
    <section id="bedrooms" className="section-spacing">
      <div className="container-luxury">
          ...
          {bedrooms.map((bedroom, index) => (
            <Card key={index} className="card-luxury overflow-hidden group">
              ...
              <CardContent className="p-6">
                <h3 className="font-heading text-2xl font-bold text-luxury-charcoal mb-4">
                  {bedroom.name}
                </h3>
        ...
        <div className="bg-luxury-champagne/20 rounded-2xl p-8 text-center">
          <h3 className="font-heading text-2xl font-bold text-luxury-charcoal mb-4">
            Sleeping Arrangements
          </h3>
          <div className="flex flex-col md:flex-row justify-center items-center gap-8">
            <div className="flex items-center">
              <Bed className="h-6 w-6 text-luxury-gold mr-3" />
              <span className="font-body text-lg">
                <strong className="font-semibold">4</strong> Queen Beds
              </span>
            </div>
            <div className="flex items-center">
              <Shirt className="h-6 w-6 text-luxury-gold mr-3" />
              <span className="font-body text-lg">
                <strong className="font-semibold">4.5</strong> Bathrooms
              </span>
            </div>
            <div className="flex items-center">
              <Eye className="h-6 w-6 text-luxury-gold mr-3" />
              <span className="font-body text-lg">
