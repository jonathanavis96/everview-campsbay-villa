    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white container-luxury py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="font-heading text-xl md:text-2xl lg:text-3xl font-light mb-4 text-luxury-champagne animate-fade-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16 animate-fade-up">
            ...
            <Button
              ...
              className="btn-luxury-outline bg-white/10 border-white/30 text-white hover:bg-white hover:text-luxury-charcoal text-lg px-10 py-4"
            >
          ...
          {/* Quick Info Strip */}
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 animate-scale-in">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
              {quickInfo.map((info, index) => (
                <div key={index} className="flex flex-col items-center text-center">
                  <info.icon className="h-8 w-8 text-luxury-gold-light mb-3" />
                  <span className="font-body text-sm font-medium">{info.label}</span>
                </div>
              ))}
            </div>
          </div>
