...
const GROUP_LABELS: Record<string, string> = {
  ...
  "bedroom-level/pool-room-and-study": "Pool room and study",
  "living-level": "Living level",
  "living-level/kitchen": "The kitchen and sunbeds",
  "living-level/living-and-dining": "The living room and dining",
  "living-level/bar-and-cellar": "The bar, wine cellar and TV room",
  "living-level/terrace": "The terrace",
  "living-level/ground-king": "Ground floor king",
  "garden-level": "Garden level",
  "garden-level/pool-and-garden": "The pool and garden",
  "entrance/entrance": "Street level",
  views: "The view",
};
