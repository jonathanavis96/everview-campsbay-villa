      ...
      <div className="container-luxury">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-body text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Perfectly positioned on Cramond Road, minutes from Camps Bay's pristine beach, 
            world-class dining, and Cape Town's most iconic attractions.
          </p>

          {/* Address Badge */}
          <div className="inline-flex items-center bg-luxury-gold/10 text-luxury-gold px-6 py-3 rounded-full">
            <MapPin className="w-5 h-5 mr-2" />
            <span className="font-body font-medium">14 Cramond Road, Camps Bay</span>
          </div>
        </div>

        {/* Map Embed Placeholder */}
        <div className="bg-luxury-champagne/30 rounded-2xl p-8 mb-16 text-center">
          <div className="bg-white/50 rounded-xl p-12 border-2 border-dashed border-luxury-gold/30">
            <MapPin className="h-16 w-16 text-luxury-gold mx-auto mb-4" />
            <h3 className="font-heading text-xl font-bold text-luxury-charcoal mb-2">
              Interactive Map
            </h3>
            <p className="font-body text-muted-foreground">
              Explore the area and discover nearby attractions, restaurants, and amenities.
              <br />
              <span className="text-sm italic">Map integration available upon request</span>
            </p>
          </div>
        </div>
          ...
          <Card className="card-luxury">
            <CardContent className="p-8">
              ...
              <p className="font-body text-muted-foreground mb-6">
                Camps Bay offers some of Cape Town's finest restaurants, all within walking distance or a short drive.
              </p>
              ...
              <div className="grid grid-cols-1 gap-3">
                {diningOptions.map((restaurant, index) => (
                  <div key={index} className="flex items-center">
                    ...
                    <span className="font-body text-sm text-foreground">{restaurant}</span>
                  </div>
                ))}
              </div>
            </CardContent>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-luxury-champagne/20 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <span className="font-body font-medium">Airport Transfer</span>
                  </div>
                  <span className="font-body text-sm text-muted-foreground">25-30 mins</span>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-luxury-champagne/20 rounded-lg">
                  ...
                  <span className="font-body text-sm text-muted-foreground">5-8 mins</span>
                </div>
                
                <div className="flex items-center justify-between p-4 bg-luxury-champagne/20 rounded-lg">
                  <div className="flex items-center">
                    <Mountain className="h-5 w-5 text-luxury-gold mr-3" />
                    <span className="font-body font-medium">Table Mountain</span>
                  </div>
                  <span className="font-body text-sm text-muted-foreground">10-15 mins</span>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="bg-gradient-to-r from-luxury-gold/10 to-luxury-champagne/20 rounded-2xl p-8 md:p-12 text-center">
          ...
          <p className="font-body text-lg text-muted-foreground max-w-2xl mx-auto">
            Minutes from Camps Bay's beach and restaurants, yet elevated for complete privacy. 
            Discover why this exclusive location offers the best of both worlds.
          </p>
        </div>
      </div>
    </section>
