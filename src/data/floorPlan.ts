...
export const FLOORS: Floor[] = [
  {
    ...
    rooms: [
      { name: "The terrace", planName: "Terrace 1", area: 48, x: 32, y: 30, w: 101, h: 180, outdoor: true },
      { name: "Scullery", area: 11, x: 142, y: 30, w: 69, h: 53 },
      { name: "Indoor dining", planName: "Dining room", area: 26, x: 142, y: 83, w: 108, h: 108 },
      { name: "The kitchen", planName: "Kitchen", area: 16, x: 142, y: 191, w: 98, h: 83 },
      { name: "Sun Beds", planName: "Living room", area: 23, x: 142, y: 274, w: 98, h: 79 },
      { name: "The garden", planName: "Garden", x: 250, y: 22, w: 285, h: 90, outdoor: true },
      { name: "Wine cellar & TV room", planName: "TV room", area: 28, x: 250, y: 112, w: 127, h: 79 },
      { name: "The bar", planName: "Bar", area: 11, x: 240, y: 191, w: 49, h: 65 },
      { name: "Stairs", planName: "Staircase", area: 2, x: 290, y: 191, w: 83, h: 27, service: true },
      { name: "Formal lounge", area: 44, x: 240, y: 256, w: 195, h: 97 },
      ...
      { name: "Planted roof", area: 58, x: 442, y: 353, w: 122, h: 69, outdoor: true },
      { name: "The Garden", planName: "Garden", area: 48, x: 32, y: 210, w: 101, h: 180, outdoor: true },
      { name: "Toilet", planName: "Bar", area: 11, x: 290, y: 218, w: 36, h: 38 },
      { name: "Passage", area: 23, x: 326, y: 218, w: 109, h: 38 },
      { name: "Bath 1", planName: "Bath 1", area: 11, x: 503, y: 146, w: 61, h: 59 },
    ],
    openings: [
      ...
      { room: "Indoor dining", side: "l", kind: "slider", at: 0.4, span: 68 },
      { room: "Sun Beds", side: "l", kind: "slider" },
      { room: "Scullery", side: "l", kind: "door", at: 0.38, span: 23, into: "outside" },
      { room: "Indoor dining", side: "r", kind: "door", at: 0.34, span: 20, into: "outside" },
      { room: "Wine cellar & TV room", side: "t", kind: "window" },
      { room: "Ground Floor King", side: "t", kind: "slider", at: 0.69 },
      { between: ["Ground Floor King", "Bath 1"], kind: "door", axis: "v", at: 0.7, span: 25, into: "Bath 1" },
      { room: "Bath 1", side: "b", kind: "window", at: 0.74, span: 15 },
      { room: "Entrance", side: "r", kind: "window", at: 0.61 },
      { room: "Entrance", side: "b", kind: "window", at: 0.38 },
      { room: "Formal lounge", side: "b", kind: "slider", span: 88 },
      { between: ["Indoor dining", "Wine cellar & TV room"], kind: "open", axis: "v", span: 74 },
      { between: ["Stairs", "Passage"], kind: "open", axis: "h", span: 42 },
      { room: "Passage", side: "t", kind: "open", span: 57 },
      { room: "Formal lounge", side: "r", kind: "window", at: 0.79 },
      { room: "Sun Beds", side: "b", kind: "window", span: 84 },
      { room: "Ground Floor King", side: "b", kind: "wall" },
      { between: ["The bar", "Formal lounge"], kind: "open", axis: "h", at: 0.46, span: 44 },
      { room: "Bath 1", side: "t", kind: "wall" },
      { room: "Scullery", side: "t", kind: "wall" },
      { room: "Scullery", side: "r", kind: "wall" },
    ],
  },
  {
    id: "bedrooms",
    ...
    rooms: [
      { name: "Bath 1", area: 18, x: 83, y: 47, w: 85, h: 98 },
      ...
      { name: "The study", planName: "Study", area: 29, x: 201, y: 126, w: 169, h: 100 },
      { name: "Bath 2", area: 8, x: 201, y: 226, w: 76, h: 67 },
      { name: "Ocean King", planName: "Bedroom 2", area: 22, x: 201, y: 293, w: 159, h: 118 },
      { name: "Balcony", area: 8, x: 201, y: 412, w: 159, h: 28, outdoor: true },
      { name: "Staircase", planName: "Staircase", area: 6, x: 277, y: 226, w: 93, h: 41, service: true },
      { name: "Bath 3", area: 10, x: 370, y: 106, w: 66, h: 88 },
      { name: "Dressing room", planName: "Dressing 4", area: 8, x: 436, y: 106, w: 102, h: 54 },
      { name: "Bath 4", area: 4, x: 392, y: 194, w: 44, h: 73 },
      { name: "Pool room", planName: "Study 2", area: 20, x: 360, y: 293, w: 76, h: 137 },
    ...
    openings: [
      ...
      { between: ["Bath 1", "Closet"], kind: "open", axis: "v", at: 0.9, span: 33 },
      { room: "Master Suite", side: "b", kind: "slider", at: 0.27, span: 65 },
      { room: "Ocean King", side: "b", kind: "slider", at: 0.36, span: 75 },
      { room: "Ocean King", side: "l", kind: "window", at: 0.66, span: 27 },
      { between: ["Pool room", "Corridor"], kind: "open", axis: "h", span: 71 },
      { room: "Corridor", side: "b", kind: "slider", at: 0.56, span: 29 },
      { room: "Dressing room", side: "t", kind: "window", span: 34 },
      { room: "Bath 3", side: "t", kind: "window" },
      { room: "The study", side: "t", kind: "window", span: 108 },
      { room: "Master Suite", side: "l", kind: "window", span: 140 },
      { room: "Bath 1", side: "l", kind: "window", span: 67 },
      { room: "Pool room", side: "l", kind: "door", at: 0.28, span: 14, into: "outside" },
      { room: "Garden King", side: "r", kind: "door", at: 0.43, span: 21, into: "outside" },
      { between: ["Bath 2", "Ocean King"], kind: "door", axis: "h", span: 29, into: "Bath 2" },
      { between: ["Master Suite", "The study"], kind: "door", axis: "v" },
      { room: "Bath 1", side: "t", kind: "wall" },
      { room: "Bath 3", side: "l", kind: "wall" },
      { room: "Bath 3", side: "b", kind: "wall" },
      { room: "Bath 4", side: "t", kind: "wall" },
      { between: ["The study", "Bath 3"], kind: "wall", axis: "v" },
      { between: ["Bath 3", "Bath 4"], kind: "wall", axis: "h" },
      { room: "The study", side: "r", kind: "open", span: 27 },
      { room: "Bath 4", side: "l", kind: "wall" },
      { room: "Corridor", side: "t", kind: "open", at: 0.5, span: 162 },
      { between: ["The study", "Staircase"], kind: "wall", axis: "h", at: 0.87, span: 42 },
      { room: "Staircase", side: "r", kind: "wall", span: 36 },
      { room: "Closet", side: "r", kind: "window", at: 0.21, span: 17 },
    ],
  },
];
